...
There are a lot of ways to think about sessions at SRCCON:POWER. We've put this guide together to help you turn your great idea into an equally great session proposal.

## In this guide
* [What Are SRCCON:POWER Sessions Like?](#about-sessions)
...
* [How We Support Session Proposers](#support)
* [Submit a Session Proposal](#submit-proposal)

<span id="about-sessions"></span>

## What Are SRCCON:POWER Sessions Like?

SRCCON events are different than many other conferences you may have attended. They are highly participatory, and you might notice that we always refer to "facilitators" or "session leaders." When you run a breakout session, you're in a room with dozens of other smart people with an opportunity to compare notes, share skills, and help everyone learn from each other.

We created SRCCON:POWER with a few principles in mind that lay the groundwork for our program as a whole:

* SRCCON:POWER is built around participation, discussion, and collaborative problem-solving.
* SRCCON:POWER exists to respond to the needs and interests of our community, and we're intentional in including perspectives from throughout the field.
...
* **October 17:** call for proposals closes at 11:59pm ET
* **October 31:** all proposers notified about status of their sessions

## Our Session Review Process

As the SRCCON team reviews proposals, we look for:

* topics that help developers, designers, journalists, and editors in newsrooms build new skills and understanding
...
Successful sessions often emerge from a single question or problem—if you’ve been struggling with just about any aspect of your work, you can bet others have dealt with it, too. Topics don't just emerge from a list of latest trends; we bring them to SRCCON:POWER because facilitators are passionate and excited to share.

As you propose an idea, your session description is the first opportunity to tell us how you'll spend time your time with everyone else who's excited about the same topic. We reserve 75 minutes for each session, which can be plenty of time to dig into even deep topics—but it does go faster than you think! Even though SRCCON:POWER is a conversational conference, a sketch of the ground you hope to cover is a great indicator of the thought you're putting into a session.
...
A co-facilitator for your SRCCON:POWER session can share the load of preparation and facilitation, as well as the fun of participating in the conference itself. If you're comfortable leading a session by yourself, that's great too!
...
To give you a taste of how facilitators turn plans into action, here are a few writeups from previous participants on their experience hosting sessions:
...
We'll reserve a ticket for purchase by facilitators of each accepted session. We do not provide free tickets for session facilitators, but we do offer need-based scholarships that anyone can apply for if they need help covering the costs of attending. (Here's [more information about scholarships to SRCCON:POWER](/scholarships).)

Why do we do it this way? SRCCON:POWER is a collaborative, peer-to-peer event, and we consider all attendees to be active participants, not just speakers or passive audience members. This approach also helps us keep ticket prices low enough to be affordable for most news organizations.


<span id="support"></span>

## How We Support Session Proposers

Ok, so you're excited to pitch your SRCCON:POWER session! If you feel ready to go, [you can submit your proposal now](/participation/form/). If you have still have some questions, we are here for you:
...
Our call for participation is open until October 17 at 11:59pm ET. We'd love to have you [pitch a session](/participation/form/) so we can consider your ideas for SRCCON:POWER, December 13 & 14 in Philadelphia.
